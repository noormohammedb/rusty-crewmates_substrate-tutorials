...
pub mod pallet {
	...
	impl<T: Config> Pallet<T> {
		...
		pub fn set_sale(
			...
			// let owned: u128 = todo!( "get the amount of this specific NFT owned by the seller, through the Resource type and its Sellable trait");
		...
		pub fn buy(
			...
			// let owned = todo!( "get the amount of this specific NFT owned by the seller, through the Resource type and its Sellable trait");
